...
import { resourcesData } from "@/utils/resources-data";
  ...
  return (
    <div>
      ...
      <div className="md:mt-10 mt-5 grid grid-cols-1  lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-5">
        {/* filter */}
        <div className="col-span-1 max-h-[350px] overflow-auto border px-2 py-1 rounded-xl">
          {filterData?.map((data) => (
            <div key={data?.value}>
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-2 xl:col-span-3 2xl:col-span-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3">
            {resourcesData?.map((resource: TResources) => (
              <div key={resource?._id} className="p-1">
                <div className="p-1">
                  <ResourcesCard data={resource}></ResourcesCard>
                </div>
              </div>
            ))}
          </div>

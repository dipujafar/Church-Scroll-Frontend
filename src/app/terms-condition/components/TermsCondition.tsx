const TermsCondition = () => {
  return (
    <div className="space-y-5">
      <h1 className="md:text-5xl text-2xl font-bold">Terms of Use</h1>
      <p>
        We value your privacy and are committed to protecting your personal
        data. This Privacy Policy explains how we collect, use, and share your
        information when you use our website or services. When you register, we
        may collect personal data such as your name, email address, phone
        number, and payment details. We collect information on how you interact
        with our website, such as IP address, browser type, and activity logs.

  ...
  return (
    <>
      <div className="flex  items-center border border-black p-2 rounded-xl  relative">
        ...
        <Button
          className={cn(
            "bg-primary-blue py-6  hover:bg-primary-black/70 absolute top-14 left-1/2 opacity-0 invisible duration-1000 ease-in z-10",
      ...
      <div
        ...
        className={cn(
          "h-screen w-[80vw]  absolute top-0 bg-transparent overflow-hidden lg:translate-y-0 translate-y-40",
